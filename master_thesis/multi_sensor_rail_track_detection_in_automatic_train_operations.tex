...
First, we compare the YOLOv8 models with unified labels and with separate lables. Figure~\ref{fig:yolo_vs_yolo} visualizes the distrubution of the Dice scores by sensor type and orientation. Both approaches seem to provide results of similar quality. 
