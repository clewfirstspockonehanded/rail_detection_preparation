...
\outline{The automation of train operations (ATO) stands as a pivotal advancement in achieving a more efficient and competitive railway system. ATO systems leverage advanced technologies to perceive and interpret the railway environment, facilitating autonomous operations with minimal human intervention. Precise identification and localization of railway tracks are fundamental for safe train navigation, prompting the need for robust track detection methods. This master's thesis addresses the task of multi-sensor rail track detection within the ATO framework, utilizing deep learning techniques, particularly convolutional neural networks (CNNs). By exploring a multi-sensor dataset comprising images from RGB, high-resolution, and infrared cameras, with varying orientations, this research aims to improve the accuracy and robustness of track detection in diverse conditions. The study compares the performance of deep learning-based segmentation with traditional non-AI-based methods, conducts comprehensive evaluations on different sensor inputs, and explores real-world application integration. The findings contribute valuable insights to the field of railway automation, offering implications for enhancing the safety and efficiency of automatic train operations.}
...
\section{Comparison baseline vs. YOLO}
...
This master's thesis delves into the realm of railway automation, specifically focusing on the task of multi-sensor rail track detection within the context of Automatic Train Operations (ATO). Leveraging deep learning techniques, particularly convolutional neural networks (CNNs), the study aims to enhance the accuracy and robustness of track detection systems, thereby contributing to the efficiency and safety of railway operations.
...
The results showcase the superiority of deep learning-based approaches, particularly YOLOv8, over traditional methods in most scenarios. YOLOv8 demonstrates robust performance across various sensor types and orientations, with infrared images yielding the highest Dice scores. Furthermore, the study sheds light on the challenges associated with low entropy images and the impact of sensor orientation on segmentation accuracy.
