...
\begin{subfigure}{.5\textwidth}
 ...
 % \label{fig:bb_wide}
\end{subfigure}
\caption{Example image on which FLD outperforms YOLOv8.}
...
In Section~\ref{sec:fld_parameter}, we observed that higher entropy leades
